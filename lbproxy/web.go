...
func initHandlers(r *mux.Router) {
	...
	r.Handle(api.PathDNSAdd, Handle(addJSONHeaders, apiDNSAdd))
...
func initSSLHandlers(r *mux.Router) {
	...
	r.Handle(api.PathDNSEdit, Handle(addSSLHeaders, addJSONHeaders, apiInfo))
	r.Handle(api.PathDNSDelete, Handle(addSSLHeaders, addJSONHeaders, apiInfo))
